...
const NgoDetails = () => {
  ...
  return (
    <div className="px-10 pt-5">
      <h1 className="text-2xl mb-6 ">Cause/NGO Details</h1>
        ...
        <div className="flex space-x-8">
          {tabs.map((tab) => (
            <button
              ...
              className={`py-4 px-1 text-sm  transition-colors relative ${
                activeTab === tab.id
                  ? " after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-[#5E5E5E]"
