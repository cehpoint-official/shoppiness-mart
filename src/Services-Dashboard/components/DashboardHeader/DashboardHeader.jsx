...
const DashboardHeader = () => {
  ...
  // Fetch notifications based on businessId
  ...
  const handleMarkAsRead = async (notificationId) => {
    try {
      const notificationRef = doc(db, "businessNotifications", notificationId);
  ...
  const handleSave = async (updatedData) => {
    try {
      await setDoc(doc(db, "businessDetails", id), updatedData, { merge: true });
