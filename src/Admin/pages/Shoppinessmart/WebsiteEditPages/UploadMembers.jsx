...
const UploadMembers = () => {
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold">About Us / Upload members image</h2>
        ...
        <div className="border bg-white shadow-md rounded-lg p-8 text-center">
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-sm text-gray-500">
              ...
              300 x 300 pixels and a maximum file size of 50 MB.
            </p>
          </div>
        </div>
            ...
            <tbody>
              {[1, 2, 3, 4].map((num) => (
                <tr key={num} className="border-t">
                  ...
                  <td className="py-3 text-gray-600">Member image{num}.jpg</td>
                  <td className="py-3">
