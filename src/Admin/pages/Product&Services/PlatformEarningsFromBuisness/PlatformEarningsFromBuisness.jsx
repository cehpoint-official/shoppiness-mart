    ...
    <div className="bg-white rounded-lg shadow-lg p-6 m-10">
            ...
            {loading ? (
              ...
              paginatedBusinesses.map((business, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <div className="text-sm font-semibold bg-blue-100 text-blue-800 px-3 py-1 rounded-full inline-block">
                      Rs.{" "}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center justify-center space-x-3">
                      ...
                      <button
                        ...
                        className={`py-1 px-3 rounded-md flex items-center transition-colors text-sm ${
                          !business.totalPlatformEarningsDue ||
                          business.totalPlatformEarningsDue <= 0
      ...
      <div className="mt-6 flex items-center justify-between bg-gray-50 p-4 rounded-lg">
        ...
        <div className="flex items-center gap-2">
          <button
            className="px-4 py-2 text-sm border border-gray-300 rounded-md hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white transition-colors"
