...
import { useContinueWithGoogleMutation, useLazyLoginQuery } from '../redux/api/AuthApi'
                ...
                <div className=''>
                    <div className=''>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-1 gap-4'>
                            <p className='text-4xl font-semibold text-center mt-10 md:mt-12'>Login</p>
                            <p className='text-xl text-gray-500 text-center mt-10'>Welcome! Login in to your account</p>
                            ...
                            <a href="" className='text-blue-600 underline text-center '>I’ve forgotten password</a>

                            <Link to="/" onClick={e => login(userData)} className='bg-[#049D8E] text-white mx-28 text-center  md:mx-56 w-64 md:w-80 px-4 py-2 rounded mt-14 md:mt-6'>
                                Login
                            </Link>
                        ...
                        <div className='mt-5 md:flex md:justify-center'>
                            <div className='mx-44 md:mx-0 md:mr-5 '>
                                <img src={Googleicon} alt="" onClick={gooleLogin} className='border-2 px-8 py-2 rounded-md  md:w-1/2 lg:w-auto' />
                            </div>
                        ...
                        <div className='mt-7 text-center'>
                            <p className='font-medium text-lg'>Don’t have an account? <a href="/signup" className=' text-[#049D8E] font-medium underline'>Signup</a></p>
                        </div>
                    </div>
                </div>
            </div>
