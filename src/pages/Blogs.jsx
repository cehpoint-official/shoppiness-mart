    ...
    <div>
      ...
      <div className="flex justify-center items-center bg-backgreenColor  py-10">
        <div className="p-6 max-w-4xl">
          ...
          <button className="bg-[#047E72]  text-white px-20 py-1 mt-5 rounded-lg">Sign Up for Free</button>
          </div>
        </div>
      </div>
      ...
      <div className=" py-20">
        ...
        <div className="flex justify-center gap-6 flex-wrap px-10 py-10">
          <div className=" bg-white md:w-[400px] w-[250px] shadow-lg rounded-lg">
            <div>
              <img src={page41} alt="Loading..." className="md:h-[291px]" />
            </div>
            ...
            <div className="flex items-center justify-center">
              <button className="bg-[#047E72]  text-white px-40 py-1 mt-5 rounded-sm">
                Read More
              </button>
            </div>
          </div>
