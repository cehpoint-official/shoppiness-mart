...
const Home = () => {
  ...
  return (
    loading ? <Loader/> : <div className=" overflow-hidden">
    {/* carousel  */}
      ...
      <div className="grid grid-cols-12 gap-2 mt-10">
        ...
        <div className="lg:col-span-7 col-span-12 mx-5  ">
          <div className="lg:flex ">
            <img src={blogsData[0].img} alt=" " className="" />
          ...
          <div className="lg:flex mt-4 ">
            <img src={blogsData[2].img} alt="" className="" />
            <div className="md:mx-4">
              <p className="font-medium text-lg mt-4">{blogsData[2].title}</p>
              <p className="text-gray-500 text-sm md:text-base">
              {blogsData[2].desc}{" "}
                <span className="text-[#049D8E] text-sm md:text-base font-medium">
                  {" "}
