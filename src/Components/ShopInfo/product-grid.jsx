  ...
  return (
    <div className="flex justify-start gap-8">
      {productList.map((product) => {
        const authedRoute = `/user-dashboard/${userId}/shop-info/${shopId}/product-info/${product.id}`;
        const unauthedRoute = `/shop-info/${shopId}/product-info/${product.id}`;
        console.log(userId ? authedRoute : unauthedRoute);
        
        return (
          <Link to={userId ? authedRoute : unauthedRoute}>
