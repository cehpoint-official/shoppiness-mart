  ...
  <div className="flex">
    <div className="w-64 bg-[#059d8e] min-h-screen text-white">
      ...
      <nav className="flex flex-col py-4">
        <Link to="/dashboard" className="py-2 px-6 hover:bg-teal-600">Dashboard</Link>
        <Link to="/ngo/details" className="py-2 px-6 hover:bg-teal-600">Cause/NGO Details</Link>
        <Link to="/ngo/performance" className="py-2 px-6 hover:bg-teal-600">Cause/NGO Performance</Link>
        <Link to="/help-support" className="py-2 px-6 hover:bg-teal-600">Help & Support</Link>
        <Link to="/about-us" className="py-2 px-6 hover:bg-teal-600">About Us</Link>
        <Link to="/faqs" className="py-2 px-6 hover:bg-teal-600">FAQ'S</Link>
        <Link to="/privacy-policy" className="py-2 px-6 hover:bg-teal-600">Privacy Policy</Link>
